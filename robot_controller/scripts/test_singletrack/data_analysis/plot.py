...
def main(): 
    ...
    est_time, est_x, est_y = load_csv("/home/tang/ros2_lab1_m/odom_estimated.csv")
    # Load Gazebo ground truth data
    gt_time, gt_x, gt_y = load_csv("/home/tang/ros2_lab1_m/odom_gazebo_limo.csv")
    ...
    plt.title(f"Trajectory Comparison: Odometry vs. Gazebo basic model\nRMS Error: {rms_error:.4f} m")
    plt.legend()
    plt.grid(True)
