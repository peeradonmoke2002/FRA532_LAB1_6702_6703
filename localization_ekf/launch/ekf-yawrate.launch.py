...
def generate_launch_description():
    ...
    ekf_config_arg = DeclareLaunchArgument(
        'config_file',
        default_value='ekf-yawrate.yaml',
    ...
    yawrate_script_path = os.path.join(get_package_share_directory(package_name), "scripts/yawrate")
    ...
    ekf_node = Node(
        package="localization_ekf",
        executable="odom_filtered_yawrate.py",
        name="ekf_node",
        output="screen"
    )
